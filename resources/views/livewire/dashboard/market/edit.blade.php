    ...
    <div class="form-row col-12 d-flex flex-wrap justify-content-around align-items-start">
        ...
        <div class="col-12 mb-2">
            ...
            <input type="text" class="form-control shadow-none border-2" id="company_or_shop_name"
                wire:model.lazy="market.company_or_shop_name">
        ...
        <div class="col-12 mb-2">
            ...
            <input type="text" class="form-control shadow-none border-2" id="address"
                wire:model.lazy="market.address">
        ...
        <div class="col-12 mb-2">
            ...
            <textarea class="form-control border-2 " id="exampleFormControlTextarea1" rows="3"
                wire:model.lazy="market.description"></textarea>
            ...
            <div class="position-relative m-1 mt-2 m-lg-1 mt-lg-1">
                ...
                <span class="border border-1 d-block position-relative box-image rounded">
                    ...
                    @if ((!$errors->has('image') && isset($image)) || isset($imagePath))
                        <div>
                            <img src="{{ $image != null && is_string($image->temporaryUrl()) ? $image->temporaryUrl() : asset($imagePath) }}"
                                class="w-100 h-100 position-absolute show-input-image rounded" id="show-image">
                        </div>
                    @endif
                        ...
                        <div class="position-relative mx-1">
                            ...
                            <span class="border border-1 d-block position-relative rounded box-image">
                                ...
                                @if (isset($images[$i]) || (!$errors->has('images.{{ $i }}') && !empty($imagesPath[$i])))
                                    <div>
                                        <img src="{{ isset($images[$i]) && is_string($images[$i]->temporaryUrl()) ? $images[$i]->temporaryUrl() : asset($imagesPath[$i]) }}"
                                            class="w-100 h-100 position-absolute show-input-image rounded"
                                            id="show-image">
                                        <span
        ...
        <div class="col-12 d-flex flex-wrap justify-content-center mb-2">
            ...
            <div class="col-12 col-md-5 m-1">
                ...
                <select class="form-control" wire:model.lazy="market.commentable">
                    ...
                    <option value="1" {{ $market->commentable == 0 ? 'selected' : '' }}>باز کردن کامنت ها
                    </option>
                </select>
            </div>
